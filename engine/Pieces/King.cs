...
namespace ChessEngine.Pieces {
    public static class King {
        static Bitboard ComputeDirectMoves(Bitboard kingLocation) {
        ...
        public static Bitboard ComputePossibleMoves(Square square, Chessboard chessboard, TurnColor? turnColor = null) {
            ...
            Bitboard moves = ComputeDirectMoves(kingLocation);
            ...
            if ((turnColor ?? chessboard.State.TurnColor) == TurnColor.White) {
                ...
                !chessboard.AreAnySquaresOccupied([Square.D1, Square.C1, Square.B1])) {
                ...
                !chessboard.AreAnySquaresOccupied([Square.D8, Square.C8, Square.B8])) {
                    castle_queen = kingLocation >> 2;
                }
            }
            
            Bitboard kingMoves = moves | castle_king | castle_queen;
        ...
        public static Bitboard ComputePossibleAttacks(Square square, Chessboard chessboard, TurnColor? turnColor = null) {
            var kingLocation = BitOperations.ToBitboard(square);
            Bitboard kingMoves = ComputeDirectMoves(kingLocation);
